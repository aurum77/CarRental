        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuitcaseCount = table.Column<int>(type: "integer", nullable: false),
                    PassengerAirbagAvailable = table.Column<bool>(type: "boolean", nullable: false),
                    AntiLockBrakesAvailable = table.Column<bool>(type: "boolean", nullable: false),
                    FuelTypes = table.Column<int[]>(type: "integer[]", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MaxJourneyLengthInKm = table.Column<int>(type: "integer", nullable: false),
                    DriverExperienceInYears = table.Column<int>(type: "integer", nullable: false),
                    MinDriverAge = table.Column<int>(type: "integer", nullable: false),
                    MinCreditCardCount = table.Column<int>(type: "integer", nullable: false),
                    ModelId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreationDate = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requirements_Models_ModelId",
                        column: x => x.ModelId,
                        principalTable: "Models",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ModelId = table.Column<Guid>(type: "uuid", nullable: false),
                    MileageInKm = table.Column<int>(type: "integer", nullable: false),
